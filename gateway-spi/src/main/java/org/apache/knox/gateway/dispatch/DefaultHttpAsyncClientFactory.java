...
public class DefaultHttpAsyncClientFactory extends DefaultHttpClientFactory implements HttpAsyncClientFactory {
    ...
    public HttpAsyncClient createAsyncHttpClient(FilterConfig filterConfig) {
        ...
        if (Boolean.parseBoolean(System.getProperty(GatewayConfig.HADOOP_KERBEROS_SECURED))) {
            ...
            credentialsProvider.setCredentials(AuthScope.ANY, new DefaultHttpClientFactory.UseJaasCredentials());
            ...
            builder.setDefaultCookieStore(new DefaultHttpClientFactory.NoCookieStore());
        }

        builder.setKeepAliveStrategy(DefaultConnectionKeepAliveStrategy.INSTANCE);
        builder.setConnectionReuseStrategy(DefaultConnectionReuseStrategy.INSTANCE);
        builder.setRedirectStrategy(new DefaultHttpClientFactory.NeverRedirectStrategy());
        ...
        //HttpAsyncClient doesn't support automatic retry
        //builder.setRetryHandler( new DefaultHttpClientFactory.NeverRetryHandler() );
        //There is no content compression in HttpAsyncClient
